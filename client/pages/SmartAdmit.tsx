...
export default SmartAdmit;
      ...
      <div className="max-w-lg mx-auto px-4">
        ...
        {!formData.major && (
          <p className="mt-2 text-xs text-red-500 text-center">
            Please select your intended major to continue
          </p>
        )}
      </div>
    </div>
      ...
      <div className="text-center space-y-6">
        ...
        <p className="text-xs sm:text-sm px-4 max-w-2xl mx-auto">
          <span className="font-bold text-[#282828]">
            Type the name of the university or select from our dropdown list of
            popular schools
          </span>{" "}
      ...
      <div className="max-w-lg mx-auto px-4">
        <Select
          onValueChange={(value) => {
            ...
            if (
              !formData.universities.includes(universityName) &&
              formData.universities.length < 5
            ) {
              updateFormData("universities", [
        ...
        {formData.universities.length > 0 && (
          <div className="mt-4 space-y-2">
            <p className="text-sm font-medium text-[#282828]">
              Selected Universities ({formData.universities.length}/5):
            </p>
            <div className="flex flex-wrap gap-2">
              {formData.universities.map((uni, index) => (
                ...
                >
                  ...
                  <button
                    onClick={() => {
                      const newUniversities = formData.universities.filter(
                        (_, i) => i !== index,
                      );
        ...
        {formData.universities.length >= 5 && (
          <p className="mt-2 text-xs text-[#797979] text-center">
            Maximum of 5 universities selected
          </p>
        )}
      </div>
    </div>
          ...
          {formData.gpaScale && (
            <div className="text-xs text-[#797979] text-center space-y-1">
              {formData.gpaScale === "4.0" && (
                <p>Range: 0.0 - 4.0 • Average: ~3.0</p>
              )}
              {formData.gpaScale === "5.0" && (
                <p>Range: 0.0 - 5.0 • Average: ~3.5</p>
              )}
              {formData.gpaScale === "100" && (
                <p>Range: 0 - 100 • Average: ~85</p>
              )}
            </div>
          )}
        </div>
  ...
  const ExtracurricularHoursStep = () => (
    <div className="space-y-12">
      <div className="text-center space-y-6">
        <h2 className="text-2xl sm:text-3xl font-bold text-[#282828] leading-tight">
          On average, how many hours per week do you spend on extracurricular
          activities?
        </h2>
      </div>
        ...
        <div className="space-y-3">
          <div className="relative w-full h-10 flex items-center">
            ...
            <div
              ...
              style={{
                width: `${(formData.extracurricularHours / 40) * 100}%`,
              }}
            />
            ...
            <div
              ...
              style={{
                left: `calc(${(formData.extracurricularHours / 40) * 100}% - 8px)`,
              }}
            />
            ...
            <input
              ...
              onChange={(e) =>
                updateFormData("extracurricularHours", parseInt(e.target.value))
              }
      ...
      <div className="max-w-lg mx-auto px-4 space-y-4">
        ...
        <Select
          onValueChange={(value) => {
            if (!formData.extracurricularTypes.includes(value)) {
              updateFormData("extracurricularTypes", [
                ...formData.extracurricularTypes,
                value,
              ]);
            }
          }}
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="student-government">
              Student Government
            </SelectItem>
            ...
            <div className="flex flex-wrap gap-2">
              {formData.extracurricularTypes.map((activity, index) => (
                ...
                >
                  ...
                  <button
                    onClick={() => {
                      const newTypes = formData.extracurricularTypes.filter(
                        (_, i) => i !== index,
                      );
        ...
        {formData.extracurricularTypes.length === 0 && (
          <p className="mt-2 text-xs text-red-500 text-center">
            Please select at least one activity type to continue
          </p>
        )}
      </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <p className="text-[#282828] font-bold text-lg">
                To improve your chances of an accurate SmartAdmit score, you can
                optionally answer a few short questions about your activities.
              </p>
            </div>
            <Button
    ...
    <div className="space-y-12">
      ...
      <div className="max-w-lg mx-auto px-4 space-y-8">
        ...
        <div className="space-y-2">
          ...
          <Select
            onValueChange={(value) => updateFormData("activityRole", value)}
            value={formData.activityRole}
          >
        ...
        <div className="space-y-2">
          ...
          <Select
            onValueChange={(value) => updateFormData("activityDuration", value)}
        ...
        <div className="space-y-2">
          <Label className="text-[#232323] font-bold">
            Hours per Week{" "}
            <span className="text-[#434343] font-bold">(optional)</span>:
          </Label>
          <Select
            onValueChange={(value) =>
              updateFormData("activityHoursPerWeek", value)
            }
            value={formData.activityHoursPerWeek}
          >
            <SelectTrigger className="w-full p-3 border border-[#E3E3E3] rounded-md bg-[#FDFDFD] text-left">
              <SelectValue
                placeholder="--Select--"
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 1:
        return <MajorSelectionStep />;
      case 2:
        return <UniversitySelectionStep />;
      case 3:
        return <SATScoreStep />;
      case 4:
        return <GPAStep />;
      ...
      case 6:
        return <ExtracurricularHoursStep />;
      case 7:
        return <ExtracurricularTypesStep />;
      case 8:
        return <MoreQuestionsStep />;
      case 9:
        return <ResultsPage />;
      default:
        return <WelcomeScreen />;
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 sm:py-20">
        ...
        <div className="flex justify-between items-center max-w-lg mx-auto px-4 mt-8 sm:mt-12">
          ...
          <Button
            onClick={nextStep}
            disabled={
              currentStep >= 9 || (currentStep > 0 && !isStepValid(currentStep))
            }
